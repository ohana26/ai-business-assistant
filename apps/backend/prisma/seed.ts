...
const permissions = [
  ...
  RBAC_PERMISSIONS.WORKSPACE_CREATE,
  RBAC_PERMISSIONS.WORKSPACE_UPDATE,
  RBAC_PERMISSIONS.WORKSPACE_DELETE,
  RBAC_PERMISSIONS.KNOWLEDGE_UPLOAD,
  RBAC_PERMISSIONS.KNOWLEDGE_VIEW,
  RBAC_PERMISSIONS.KNOWLEDGE_DELETE,
  RBAC_PERMISSIONS.ASSISTANT_CREATE,
